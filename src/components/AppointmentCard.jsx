  ...
  return (
    <div className="group bg-white rounded-[28px] overflow-hidden border border-slate-100 shadow-sm hover:shadow-[0_20px_60px_rgba(0,0,0,0.12)] transition-all duration-500 hover:-translate-y-2">
      ...
      <div className="p-6 space-y-4">
        ...
        {/* NAME */}
        <div>
          <h2 className="text-2xl font-extrabold text-slate-900 group-hover:text-[#F96363] transition">
            {name}
          </h2>
        ...
        <div className="space-y-2 text-slate-600 text-sm">
          ...
          <div className="flex items-center gap-2">
            <Clock3 className="w-4 h-4 text-[#F96363]" />
            <span>{experience} Experience</span>
          </div>

          <div className="flex items-center gap-2">
            <MapPin className="w-4 h-4 text-[#F96363]" />
            <span>{location}</span>
          </div>
        ...
        <div className="flex items-end justify-between pt-4 border-t border-slate-100">
          ...
          <div>
            ...
            <h3 className="text-3xl font-black text-[#F96363]">
              ৳{fee}
            </h3>
          </div>

          <Link href={`/appointment/${_id}`}>
            <Button className="rounded-full px-6 py-2 bg-[#F96363] text-white font-semibold shadow-md hover:shadow-xl hover:bg-[#ef4d4d] transition">
              View Details
            </Button>
          </Link>
