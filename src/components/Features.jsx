    ...
    <section className="relative py-24 bg-slate-50 overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        ...
        <div className="text-center mb-16">
          <p className="text-[#F96363] font-bold tracking-widest uppercase text-sm">
            Why Choose Us
          </p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          {items.map((item, i) => (
            ...
            >
              ...
              <div className="w-14 h-14 rounded-2xl bg-[#F96363]/10 flex items-center justify-center mb-4">
                <item.icon className="w-7 h-7 text-[#F96363]" />
              </div>
