    ...
    <nav className={`sticky top-0 w-full z-50 transition-all duration-300 ${scrolled ? "bg-white/70 backdrop-blur-md shadow-sm py-2" : "bg-slate-50 py-4"
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between h-16 items-center">
          ...
          <div className="hidden md:flex gap-8 items-center">
            <Link href="/" className="font-medium text-slate-700 hover:text-[#F96363] transition-colors">Home</Link>
            <Link href="/appointment" className="font-medium text-slate-700 hover:text-[#F96363] transition-colors">All Appointments</Link>
          
            <Link href="/dashboard" className="font-medium text-slate-700 hover:text-[#F96363] transition-colors">Dashboard</Link>
          </div>
          ...
          <div className="hidden md:flex items-center gap-4">
            ...
            {
              !isPending && !session ? <>
                <Link href="/login" className="font-medium text-slate-700 hover:text-[#F96363] transition-colors">Login</Link>
                <Link href="/register">
      ...
      {isMenuOpen && (
        <div className="md:hidden px-4 pt-2 pb-6 space-y-2 bg-white border-b border-slate-200 animate-in slide-in-from-top duration-300">
          ...
          <Link href="/appointment" className="block px-4 py-3 text-base font-medium text-slate-900 hover:bg-slate-50 rounded-xl">All appointments</Link>
